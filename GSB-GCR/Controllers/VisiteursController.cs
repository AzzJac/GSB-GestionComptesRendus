...
namespace GSB_GCR.Controllers
{
    ...
    public class VisiteursController : Controller
    {
        ...
        public VisiteursController(GSBCRContext context)
        {
            _context = context;
        }
        ...
        {
            var gSBCRContext = _context.Visiteurs.Include(v => v.LabCodeNavigation).Include(v => v.SecCodeNavigation);
        ...
        {
            ViewData["LabCode"] = new SelectList(_context.Labos, "LabCode", "LabNom");
            ViewData["SecCode"] = new SelectList(_context.Secteurs, "SecCode", "SecLibelle");
            return View();
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'GSBCRContext.Visiteurs'  is null.");
            }
            var visiteur = await _context.Visiteurs.FindAsync(id);
            if (visiteur != null)
            {
